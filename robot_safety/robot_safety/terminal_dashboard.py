...
# Importations mte3 l'makeup (Rich)
...
class TerminalDashboard(Node):
    def __init__(self):
        ...
        # 2. Les Subscribers (Yfadhw l'mémoire)
        ...
        # 3. Timer l'affichage (Kol 0.5 seconde, yrsem l'écran)
        self.timer = self.create_timer(0.5, self.draw_screen)

    def sensor_cb(self, msg):
        # Nfadhw l'mémoire bla ma nrsmou
    ...
    def draw_screen(self):
        ...
        # Logique des couleurs (L'intelligence mte3 l'dashboard)
        ...
        # L'SI7R: Nmsa7 l'écran w naffich l'tableau f nafs l'blasa
        self.console.clear()
